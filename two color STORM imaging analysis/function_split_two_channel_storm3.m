...
function function_split_two_channel_storm3(dataPath, FileName)
output_folder='split\';
...
for i = 1:size(Datafiles, 3)
    Datafiles_f=rot90(Datafiles(:,:,i),3);
    imagesc(Datafiles_f)
    LeftDatafiles(:,:,i) = Datafiles_f(1:256,1:256);
    RightDatafiles(:,:,i) = Datafiles_f(1:256,257:512);
end
